...
//    init(entityHash: String, position: Int, sharedStepHash: String? = nil, sharedStepNestedHash: String? = nil,
//         attachments: List<Int>, action: String? = nil, expectedResult: String? = nil, data: String? = nil
//    ) {
//        super.init()
